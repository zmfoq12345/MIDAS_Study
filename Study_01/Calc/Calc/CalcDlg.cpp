...
BEGIN_MESSAGE_MAP(CCalcDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_QUIT, &CCalcDlg::OnClickedButtonQuit)
	ON_BN_CLICKED(IDC_BUTTON_RESET, &CCalcDlg::OnClickedButtonReset)
END_MESSAGE_MAP()
...
void CCalcDlg::OnClickedButtonEqu()
{
	...
	{
	case 1: 
		tmpResult = StrToInt(m_nNum1) + StrToInt(m_nNum2);
		break;
...
void CCalcDlg::OnClickedButtonReset()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	UpdateData(TRUE);
	m_nNum1 = _T("");
...
void CCalcDlg::OnClickedButtonQuit()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	PostQuitMessage(0);
}
