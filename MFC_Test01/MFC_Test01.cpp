...
// MFC_Test01.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CMFCTest01App, CWinAppEx)
...
CMFCTest01App::CMFCTest01App() noexcept
{
...
BOOL CMFCTest01App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMFCTest01Doc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CMFCTest01View));
	if (!pDocTemplate)
		return FALSE;
...
// CMFCTest01App 사용자 지정 로드/저장 방법

void CMFCTest01App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CMFCTest01App::LoadCustomState()
{
}

void CMFCTest01App::SaveCustomState()
{
}
